...
static const dmg_color_t PALETTE[] = {
	{{ 0xff, 0xe2, 0xf3, 0xe4 }}, /* DMG_PALETTE_WHITE */
	{{ 0xff, 0x94, 0xe3, 0x44 }}, /* DMG_PALETTE_GREY_LIGHT */
	{{ 0xff, 0x46, 0x87, 0x8f }}, /* DMG_PALETTE_GREY_DARK */
	{{ 0xff, 0x2f, 0x29, 0x4a }}, /* DMG_PALETTE_BLACK */
	};
