...
static dmg_error_e dmg_system_initialize_video(dmg_handle_t const handle)
{
...
static void dmg_system_update(dmg_handle_t const handle)
{
...
dmg_error_e dmg_system_initialize(dmg_handle_t handle, const dmg_data_t *const data, const dmg_output_f output)
{
    ...
    if ((result = dmg_system_initialize_video(handle)) != DMG_SUCCESS)
    {
        return result;
    }
    if ((result = dmg_system_initialize_audio(handle)) != DMG_SUCCESS)
    {
        return result;
    }
