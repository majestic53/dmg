...
static dmg_error_t dmg_initialize_audio(dmg_handle_t const handle)
{
...
static dmg_error_t dmg_initialize_video(dmg_handle_t const handle)
{
...
static dmg_error_t dmg_sync(dmg_handle_t const handle)
{
