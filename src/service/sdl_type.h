...
#define PALETTE_MASK 0xff
#define PALETTE_MASK_BLUE (PALETTE_MASK << PALETTE_SHIFT_BLUE)
#define PALETTE_MASK_GREEN (PALETTE_MASK << PALETTE_SHIFT_GREEN)
#define PALETTE_MASK_RED (PALETTE_MASK << PALETTE_SHIFT_RED)
